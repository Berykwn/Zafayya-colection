                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                        ...
                        <tbody>
                            <tr className="bg-white border-b-2 border-gray-200">
                                ...
                                <td className="px-6 py-2">
                                    {usePriceFormated(transaction.total_price)}
                                </td>
                                <td className="px-6 py-2">
...
const PrintDetailTransaction = ({ transaction, totalTransaction }) => {
    const componentRef = useRef();

    return (
        <div>
            <Head title="Print Detail Trasaction Report" />
...
export default PrintDetailTransaction;
